...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY29kZWd1eWtldGFuIiwiYSI6ImNrdjE4Y3R0eDBlY28yb3BueWxuZzczZnUifQ.lzHG5YHjmIkug9F8g4LYRw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " ").concat(loc.description, "</p>")).addTo(map); //Extends map bouunds to include current location
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51K9l2aSA8AWcps43dv9QLYMhGWlRXIUNyR8PbWKnslw1kciu6cLHV5Q2H4gnQraddUvXpQMrI8hDW920lV2ngDrI00OTT1Mxhy');
            _context.prev = 1;
            _context.next = 4;
