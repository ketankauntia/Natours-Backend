...
const tourSchema = new mongoose.Schema(
  {
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function(val) {
          //only points to current document and only on creation.
    ...
    summary: {
      type: String,
      trim: true, //removes all blank spaces from the front and end.
...
tourSchema.pre(/^find/, function(next) {
  this.find({ secretTour: { $ne: true } }); //$ne = true :: not equal to true
